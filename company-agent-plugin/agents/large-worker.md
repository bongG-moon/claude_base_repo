...
- Read the selected workflow Skill before making its deliverable. Use only the parent's explicit runtime paths and scope; never guess another user's state.
